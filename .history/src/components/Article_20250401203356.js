    ...
    <div className="article-container">
      ...
      <div className="tags-description">
        ...
        <div className="description">
          <div className="description-text">{article.description}</div>
              ...
              {showTooltip && (
                <div className="tooltip">
                  ...
                  <div className="tooltip-actions">
                    <button onClick={toggleTooltip} className="tooltip-cancel-btn">
                      No
                    </button>
                    <button onClick={handleDelete} className="tooltip-confirm-btn">
                      Yes
                    </button>
                  </div>
                </div>
