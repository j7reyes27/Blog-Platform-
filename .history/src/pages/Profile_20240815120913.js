...
import Post from '../components/Post'; // Make sure to adjust the import path based on your project structure
                ...
                articles.length > 0 ? (
                    <div className="posts-container">
                        {articles.map((article) => (
                            <Post key={article.slug} article={article} />  {/* Use Post component */}
                        ))}
                    </div>
                ) : (
