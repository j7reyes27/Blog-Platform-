...
const Profile = () => {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
                try {
                    const response = await fetch(`https://api.realworld.io/api/articles?author=${storedUser.username}`);
                    const data = await response.json();
                    console.log('Fetched articles:', data.articles); // Log the articles array
