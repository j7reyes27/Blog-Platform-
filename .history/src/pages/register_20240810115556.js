...
const Register = () => {
    ...
    //...register spreads out the register objeect which has keys like name, onChange, onBlur etc. it assigns the name from the first argument. so name='username' it only returns it, it doesnt store it but react-hook-form management manages everything internally and keeps track of all the fields. 
